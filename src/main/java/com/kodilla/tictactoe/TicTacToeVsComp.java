...
public class TicTacToeVsComp {
    ...
    private void welcomeInfo() {
        System.out.println("\n#### Kóło i krzyżyk ####");
        System.out.println("Aby grać wpisuj pozycję X według wzoru\n");
        ...
        if(actualPlayer == 'X') {
            while (true) {
                ...
                if (arrBoard[rowIndex][colIndex] != EMPTY) {
                    System.out.print("To pole jest już zajęte. Spróbuj jeszcze raz.");
                    continue;
                }
                break;
            }
            arrBoard[rowIndex][colIndex] = 'X';
        }
        else {
            while (true) {
            ...
            System.out.println("\n\nO wybiera pole: " + number);
            arrBoard[rowIndex][colIndex] = 'O';
        }
    }
